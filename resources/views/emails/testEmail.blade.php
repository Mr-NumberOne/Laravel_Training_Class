                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; width: 590px; margin: 0 auto;"
                               width="590">
                            <tbody>
                            <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="heading_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad" style="text-align:center;width:100%;">
                                                <h1 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 23px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                    <strong><span class="tinyMce-placeholder">Hello& welcome to Mr.Number One's Store</span></strong>
                                                </h1>
                                            </td>
                                        </tr>
                                    </table>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2" role="presentation"
                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; border-radius: 0; width: 590px; margin: 0 auto;"
                               width="590">
                            <tbody>
                            <tr>
                                <td class="column column-1"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        alt="Image"
                                                        src="https://media2.giphy.com/media/FM0DQEF2JNja0/giphy.gif?cid=20eb4e9depj6ngvmo5iki3vmof1ab2mozsqiyel7lkj238gc&ep=v1_stickers_trending&rid=giphy.gif&ct=s"
                                                        style="height: auto; display: block; border: 0; max-width: 147.5px; width: 100%;"
                                                        title="Image" width="147.5"/></div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td class="column column-2"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        src="images/final_final_001.png"
                                                        style="height: auto; display: block; border: 0; max-width: 442.5px; width: 100%;"
                                                        width="442.5"/></div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div
                                                    ...
                                                    <p style="margin: 0;">Let's Make some Money</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
