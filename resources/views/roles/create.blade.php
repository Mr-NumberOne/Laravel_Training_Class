    ...
    <div class="col-12 p-3">
        <div class="col-12 col-lg-12 p-0 ">
            <form id="validate-form" class="row" enctype="multipart/form-data" method="POST"
                                ...
                                <tr>
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if(isset($role)&&$role->hasPermissionTo('create-'.$permission->group)) checked
                                                       @endif
                                                       name="permissions[]">
                                            </div>
                                        </td>
                                    ...
                                    @if($sub_permissions->where('name','access-'.$permission->group)->first())
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       id="{{'access-'.$permission->group}}"
                                                       value="{{'access-'.$permission->group}}"
                                                       @if(isset($role)&&$role->hasPermissionTo('access-'.$permission->group)) checked
                                                       @endif
                                                       name="permissions[]">
                                            </div>
                                        </td>
                                    ...
                                    @if($sub_permissions->where('name','update-'.$permission->group)->first())
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       id="{{'update-'.$permission->group}}"
                                                       value="{{'update-'.$permission->group}}"
                                                       @if(isset($role)&&$role->hasPermissionTo('update-'.$permission->group)) checked
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if(isset($role)&&$role->hasPermissionTo('delete-'.$permission->group)) checked
                                                       @endif name="permissions[]">
                                            </div>
                                        </td>
                                    @else
                ...
                <div class="col-12 p-3">
                    <button class="btn btn-primary" id="submitEvaluation">Save</button>
                </div>
            </form>
        </div>
    </div>
